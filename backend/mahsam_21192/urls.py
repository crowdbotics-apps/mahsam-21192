"""mahsam_21192 URL Configuration
...
admin.site.site_header = "mahsam"
admin.site.site_title = "mahsam Admin Portal"
admin.site.index_title = "mahsam Admin"

# swagger
api_info = openapi.Info(
    title="mahsam API",
    default_version="v1",
    description="API documentation for mahsam App",
)
